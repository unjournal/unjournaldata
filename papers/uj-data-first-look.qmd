...
about which journals count as e.g. "top".^[We also provide some specifics examples of journals that seem likely to represent these tiers; see [here](https://docs.google.com/spreadsheets/d/1nnS0FMOIKz-3rFJMn-JsX-6_oE54gdvCjxs0vac6WF8/edit#gid=0).]
...
<!-- DR: The word 'accurate' makes me think of something more fine-grained than what I think we mean here. The question is 'whether the evaluators give measures that are correlated *anything* important and about the paper'. When I here 'accurate' I think of situations where everyone knows what we are aiming for, and we are pretty confident people are providing something in this direction ... but some people may hit the target much more closely. -->
...
<!-- DR: I weakly suggest replacing 'better' with 'more positive' with or without scare quotes. Because 'better' could be read as 'the evaluation was done more carefully, showed more insight, etc'. -->

4. Do evaluators understand the questions? Do they "grok" how our percentile
   questions, upper bounds, and lower bounds work?

<!-- DR: Perhaps we are demanding more than just an understanding of percentiles and CI's in principle. We want them to be able to apply it to this case, and to understand how to express their own uncertainty in a calibrated way.  I'm not sure if 'grok' and 'work' fully captures this -->
...
<!-- DR: do you think it's worth unpacking this into 1. whether they interpret the criteria similarly, as a vector in a particular direction and 2. Whether they interpret the percentile (or journal tier) scale similarly, considering comparable reference groups etc? -->
...
data, we might find that both raters are really drawing evenly from $\{0, 1, 2, 3, 4, 5, 6}$.
<!-- DR: I guess this is what you meant? -- see the suggested change -->
Krippendorff's alpha corrects for this problem by adjusting $p_e$ when the number of ratings is small.
<!-- DR: Maybe this 'correction for small distributions part' should be put in a footnote? I'm also a bit curious to get a sense of how they might correct for this. -->
...
<!-- DR: But this might be driven by some of the evaluators giving degenerate CIs or leaving some categories blank? -->
