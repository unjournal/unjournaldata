...
- **100-150 papers** (est.) appear in institutional repositories (only 40 as primary URL, but most papers are cross-posted to authors' university repos)
...
hosts <- data.frame(
  ...
  Eval_Detected = c(15, 8, 17, 4, 22, 2, 14, 4, 1, 3, 0, 0, 0),
  Eval_Est = c("15", "25-35‡", "17", "4", "22+", "2", "25-30†", "4", "1", "3", "0-1", "0", "0"),
  All_Detected = c(113, 40, 66, 58, 49, 40, 39, 18, 18, 14, 5, 5, 1),
  All_Est = c("113", "100-150‡", "66", "58", "50-60", "40", "80-100†", "18", "18", "14", "6-8", "5", "1"),
...
- *‡Institutional repos estimates:* Only 40 papers have institutional repos as their primary URL, but papers hosted on NBER, SSRN, or personal sites are typically also deposited in the authors' institutional repositories. Based on DOI coverage and author affiliations, we estimate 100-150 papers (30-45% of database) are actually present in institutional repos.
...
**Distribution among Unjournal papers:** Of the ~40 papers with institutional repositories as their primary URL, we can identify the underlying platform for 18:

- **EPrints**: 11 papers (2 evaluated, 9 pipeline) — LSE Research Online, Southampton, Edinburgh Research Explorer
- **DSpace**: 5 papers (all pipeline) — Cambridge Apollo, MIT DSpace, various European universities
- **PURE**: 1 paper (pipeline) — Radboud Repository
- **eScholarship**: 1 paper (evaluated) — UC system custom platform

The remaining ~22 papers use platforms that aren't easily identifiable from URLs (including custom university systems). When accounting for cross-posting, estimated actual platform distribution is:

- **DSpace**: ~40-60 papers (DSpace 8's COAR Notify support makes this a major opportunity)
- **EPrints**: ~20-30 papers (strong UK presence)
- **PURE**: ~15-25 papers (Nordic/Dutch universities)
- **HAL**: ~5-10 papers (French institutions)
- **Other/custom**: ~10-20 papers

### Specific University Repositories

Based on primary URL analysis, approximately **40 papers** have institutional repositories as their primary host. However, the actual number is likely **100-150 papers** (30-45% of database) when accounting for cross-posting — papers hosted on NBER, SSRN, or personal sites are typically also deposited in the authors' institutional repositories.
