...
<!-- Todos (DR suggestions)
- Move some of this explanation to the hover footnotes or collapsed boxes
- Add or link an explanation to the intuition behind this measure ... e=what it actually computes, and whether the magnitude has an intuitive interpretation
-->
