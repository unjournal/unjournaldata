...
Below, we are building an interactive dashboard.^[We are working to enable a range of presentations, aggregations, and analyses (your suggestions are welcome), including reasonable approaches to incorporating evaluator uncertainty] ([See the code on GitHub](https://github.com/unjournal/unjournaldata/blob/958dbaeb8e698695f32488a7249448b8786a2fc4/shinyapp/DataExplorer/app.R))
