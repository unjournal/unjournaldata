...
Below, for each category and prediction (overall and by paper). Evaluations made by anonymous reviewers are marked with a black border around the rating.
...
g1 <- evals_pub %>% 
  ...
  ggplot(aes(x = paper_abbrev, y = overall, group = paper_abbrev, 
...
<!-- todo (DR @julia) make the spider plots easier to compare across papers (see slack thread) -->
