...
niso=Pubshelper(community_url="https://testabcd123456789.pubpub.org",
                community_id="fce230e8-c211-40e1-8a34-60a65c1aad08",email="evltr@gmail.com", password='8pswrt')


niso.login()

many = niso.get_byreleased_pubs(isReleased=True)
print("Pubs released/published isReleased=True ======")
print(many)
print("======")

many = niso.get_byreleased_pubs(isReleased=False)
print("Pubs not published ======")
print(many)
print("======")


one = niso.getPub('a23fe047-fe63-4696-904f-527af8d256cc')
print('== one')
print(one)


print('delete Pub =====')
delPub= niso.delete_pub('a23fe047-fe63-4696-904f-527af8d256cc')
print(delPub)
